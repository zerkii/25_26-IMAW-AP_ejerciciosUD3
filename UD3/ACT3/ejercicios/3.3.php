...
<html lang="en" class="h-100" data-bs-theme="auto">
	<head>
		...
		<meta name="description" content="Ejercicio 3.3 - Traducción de Colores" />
		<title>Ejercicio 3.3 - Traducción de Colores</title>
	...
	<body class="d-flex flex-column h-100">
						...
						<ul class="navbar-nav me-auto mb-2 mb-md-0">
							...
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><a class="dropdown-item active" href="3.3.php">3.3 - Colores</a></li>
								</ul>
							</li>
						</ul>
					</div>
		...
		<main class="flex-shrink-0">
			<div class="container">
				<h1 class="mt-5">3.3 - Traducción de Colores</h1>
