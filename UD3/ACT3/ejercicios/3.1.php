...
<html lang="en" class="h-100" data-bs-theme="auto">
	<head>
		...
		<meta name="description" content="Ejercicio 3.1 - Comparación de números" />
		<title>Ejercicio 3.1 - Comparación de números</title>
	...
	<body class="d-flex flex-column h-100">
						...
						<ul class="navbar-nav me-auto mb-2 mb-md-0">
							...
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu">
									<li><a class="dropdown-item active" href="3.1.php">3.1 - Comparación</a></li>
									<li><a class="dropdown-item" href="3.2.php">3.2 - Bombilla</a></li>
		...
		<main class="flex-shrink-0">
			<div class="container">
				<h1 class="mt-5">3.1 - Comparación de números</h1>
